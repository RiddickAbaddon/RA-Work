...
var delete_old_attachments = new Array();
...
function add_attachment() {
    ...
    var index_old = old_attachments.findIndex(x => x.name == attachment_name);
    if(index != -1 || index_file != -1 || index_old != -1) {
...
function delete_attachment(name) {
    ...
    var index_old = old_attachments.findIndex(x => x.name == name);
    ...
    if(index != -1) {
        ...
        var element = old_attachments[index_old];
        delete_old_attachments.push(element);
        old_attachments.splice(index_old, 1);
        $('.stat-options[data-attachment-name="'+name+'"]').remove();
    }
}
var can_send = true;
